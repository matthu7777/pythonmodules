...
"""
a module to calculate elliptical orbits. Includes a class to define orbits,
and various routines to deal with elliptical orbits as well.
...
Some routines construct orbits from a dictoinary of parameters. This should be
defined as follows (this is a complete lsit and not all are needed for all
routines):
